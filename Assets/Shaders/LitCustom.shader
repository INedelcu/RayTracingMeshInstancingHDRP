Shader "HDRP/LitCustom"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "RaytracingIntersectionWithProcedural.hlsl"
#else
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/Raytracing/Shaders/RaytracingIntersection.hlsl"
#endif
            ...
            void BoxIntersectionMain()
            {
                ...
                bool isHit = RayBoxIntersectionTest(GetAbsolutePositionWS(WorldRayOrigin()), WorldRayDirection(), aabbPos, aabbSize * 0.5, outHitT, outNormal, outUVs, outFaceIndex);
